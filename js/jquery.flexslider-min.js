 ...
 * Contributing Author: AgroTicNarino
 */
! function ($) {
    var e = !0;
    $.flexslider = function (t, a) {
        ...
        $.data(t, "flexslider", n), f = {
            ...
            directionNav: {
                setup: function () {
                    var e = $('<ul class="' + i + 'direction-nav"><li class="' + i + 'nav-prev"><a class="' + i + 'prev ti-angle-left" href="#">' + n.vars.prevText + '</a></li><li class="' + i + 'nav-next"><a class="' + i + 'next ti-angle-right" href="#">' + n.vars.nextText + "</a></li></ul>");
