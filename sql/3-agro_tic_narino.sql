...
-- Tiempo de generación: 18-08-2022 a las 00:22:24
...
(7, 'Noticia 1  Plataforma Agrotic', 'Introducción a la noticia 1 de Agrotic Nariño', 'Este es el contenido general de la noticia 1', 'carousel-7.jpg', '2022-07-11 19:05:40', 1, 4);
...
(36, 'Papa', 'Tuberculos', 'producto-1.jpg', 5000, 'Kilogramos', 0, NULL, NULL);
...
CREATE TABLE `slider` (
  ...
  `text_botton` varchar(50) NOT NULL,
  `url_botton` text NOT NULL,
  `style_botton` varchar(30) NOT NULL,
...
(1, 'Prueba 1 con el slider', 'EL resto es muy grande con el slider 1. mi primer slider programado', 'carousel-4.jpg', 'Ver ahora', 'Ver mas   ', 'warning', 1, 1, '2021-07-12 17:08:08');
...
(14, 'Uno', 'Dos', 'trestres', 'cuatro@gmail.com', '1f82ea75c5cc526729e2d581aeb3aeccfef4407e', NULL, 1, 1, '2022-07-10 11:19:42'),
(15, '123', '2456', '32233344', '4444444', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad', NULL, 1, 1, '2022-07-12 13:48:22');
