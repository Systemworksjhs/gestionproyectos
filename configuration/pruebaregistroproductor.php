<?php
    ...
    if (!empty($_POST)) {
        ...
        if (count($errors) == 0){
            $registro = registraProducer($genero, $name_initiative, $description_initiative, $image, $direction, $url_web, $email, $twitter, $facebook, $instagram, $cod_municipality, $id_initiatives, $estado, $documento, $phone, $productHome, $fechacreacion, $nrocedula, $corregimiento);
            if ($registro > 0){
