                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="addproviders" action="./?action=providers&opt=add" role="form">
                            ...
                            <div class="form-group">
                                <label for="image" class="col-sm-3 control-label">Foto de perfil (Opcional) Tamaño recomendado es de 900 x 500 píxeles.</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="phone" required class="form-control" id="phone" placeholder="contacto" minlength="10" maxlength="10">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="address" required class="form-control" id="address" placeholder="Dirección" minlength="5" maxlength="30">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="municipality" class="col-lg-2 control-label">Municipio *</label>
                                <div class="col-md-6">
                            ...
                            <!-- <div class="form-group">
                                <label for="files" class="col-sm-3 control-label">Tamaño maximo es de 2 megas.</label>
                                <div class="col-md-9 fileinput fileinput-new" data-provides="fileinput">
                                    <div>
                                        <span class="btn btn-info btn-file"><span class="fileinput-new">Arrastre o Seleccione un archivo</span>
                                        <input type="file" name="files" id="files" required accept=".pdf" />
                                    </div>
                                </div>
                            </div> -->
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-2 col-lg-10">
                                    <button type="submit" class="btn btn-primary">Agregar proveedor</button><a href="#" class="btn btn-danger" style="margin-left: 7px;" data-dismiss="modal"><i class="fa fa-times"> </i>&nbsp&nbspCancelar</a>
                                </div>
                            </div>
                        </form>
                    </div>
