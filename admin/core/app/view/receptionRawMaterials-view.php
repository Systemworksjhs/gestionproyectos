...
<section class="content">
    <div class="row">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal" method="post" id="addnewregistro" action="./?action=receptionRawMaterials&opt=add" role="form">
        ...
        <br><br>
        <?php
            $receptionRawMaterials = receptionRawMaterialsData::getAll();
                    ...
                    <div class="box-body">
                        <table class="table table-bordered table-hover datatable">
                            ...
                            foreach($receptionRawMaterials as $receptionRawMaterial){
                                ...
                                <a href="./?action=receptionRawMaterials&opt=del&idcitorga=<?php echo base64_encode($receptionRawMaterial->id_product_return);?>" class="btn btn-danger btn-xs">Eliminar</a>
                            </td>
                            </tr>
                            <?php
                            }
                        ...
                        <div class="modal fade" id="editModal<?php echo $receptionRawMaterial->id_product_return; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog modal-lg" role="document" >
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel">Editar registro de materia prima</h4>
                                    </div>
                                    <div class="modal-body">
                                        <form class="form-horizontal" enctype="multipart/form-data" method="post" id="editreturnregistration" action="./?action=receptionRawMaterials&opt=update" role="form">
                                            <div class="form-group">
                                                <label for="Date_Registration" class="col-lg-2 control-label">Fecha*</label>
                                                <div class="col-md-6">
