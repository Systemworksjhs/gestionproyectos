...
<?php if(($u->kind==1)or($u->kind==4)or($u->kind==3)):?>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" enctype="multipart/form-data" method="post" id="addproduct" action="index.php?action=posts&opt=update" role="form">
                                                <div class="form-group">
                                                    <label for="title" class="col-lg-2 control-label">Titulo*</label>
                                                    <div class="col-md-10">
                                                    <input type="text" name="title" value="<?php echo $post->title;?>" class="form-control" id="title" placeholder="Titulo" required  minlength="10" maxlength="160" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="brief" class="col-lg-2 control-label">Descripcion Breve*</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="posturl" class="col-lg-2 control-label">Url externa</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="posturl" value="<?php echo $post->urlpost;?>" class="form-control" id="posturl" placeholder="Url noticia externa"  minlength="10" maxlength="200">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="formUrl" class="col-lg-2 control-label">Enlace a formulario</label>
                                                    <div class="col-md-10">
                                                        <input type="text" name="formUrl" value="<?php echo $post->registrationForm;?>" class="form-control" id="formUrl" placeholder="Enlace a formulario"  minlength="10" maxlength="200">
                                                    </div>
                                                </div>
                                                <div class="form-group">
