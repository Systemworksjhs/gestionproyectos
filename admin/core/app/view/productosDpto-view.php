                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" enctype="multipart/form-data" method="post" id="addproduct" action="./?action=productosDpto&opt=update" role="form">
                                                ...
                                                <!--<div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="number" name="price" value="<?php echo $producto->price;?>" required class="form-control" id="price" placeholder="Precio">
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="weight_unit" class="col-lg-2 control-label">Unidad de media*</label>
                                                    <div class="col-md-6">
                                                        <input type="number" name="weight_unit" value="<?php echo $producto->weight_unit;?>" required class="form-control" id="weight_unit" placeholder="Unidad de media">
                                                    </div>
                                                ...
                                                <!--
                                                    <div class="form-group">
                                                        <label for="weight_unit" class="col-lg-2 control-label">Unidad de media*</label>
                                                        <div class="col-md-6">
                                                            <select class="form-control" id="weight_unit" required name="weight_unit">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                         ...
                                                         <select onchange="actualizarP()" name="presentations[]" id="sPresentations"  multiple aria-label="multiple select example">
                                                            <?php foreach($presentations as $presentation):?>
                                                                <option  value="<?php echo $presentation->name.",".$presentation->grams; ?>"
                                                                    
                                                                    <?php foreach(json_decode($producto->presentation) as $key=>$value):?>
                                                                        <?php if($value->name == $presentation->name): ?>
                                                                            
                                                                            <?php echo "selected";break;?>
                                                                        <?php endif ?>
...
<script>
    function actualizarP(){
        var seleccionados = $("#sPresentations");
        console.log("seleccion:",seleccionados);
    }
    actualizarP();
</script>
