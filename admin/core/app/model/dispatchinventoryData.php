<?php
	class dispatchinventoryData {
		public static $tablename = "dispatch_inventory";

		public function dispatchinventoryData(){
			$this->name = "";
		}
		...
		// partiendo de que ya tenemos creado un objecto dispatchinventoryData previamente utilizamos el contexto
		...
		public static function getById($id){
			...
			return Model::one($query[0],new dispatchinventoryData());
		}

		public static function getAll(){
			$sql = "select * from ".self::$tablename;
			$query = Executor::doit($sql);
			return Model::many($query[0],new dispatchinventoryData());
