<?php
	class productReturnRegistrationData {
		public static $tablename = "product_return_registration";

		public function productReturnRegistrationData(){
			$this->name = "";
		}
		...
		// partiendo de que ya tenemos creado un objecto productReturnRegistrationData previamente utilizamos el contexto
		...
		public static function getById($id){
			...
			return Model::one($query[0],new productReturnRegistrationData());
		}

		public static function getAll(){
			$sql = "select * from ".self::$tablename;
			$query = Executor::doit($sql);
			return Model::many($query[0],new productReturnRegistrationData());
